...
export default function CurrentIssuePage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      <Header />
      <section className="bg-[#800080] text-white py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex flex-wrap gap-3">
                <button className="inline-flex items-center gap-2 bg-transparent border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-[#800080] transition-all">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="px-4 py-2 border-2 border-[#EAD3D9] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#800080] font-medium"
              >
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          {filteredArticles.map((article, index) => (
            <Link
              ...
              key={article.id}
              className="block bg-white border-2 border-[#EAD3D9] rounded-xl overflow-hidden hover:shadow-xl hover:border-[#800080] transition-all transform hover:scale-[1.02]"
            >
              <div className="p-8">
                <div className="flex flex-wrap items-center gap-3 mb-4">
                  <span className="inline-flex items-center px-3 py-1 bg-[#FFE9EE] border border-[#E6B6C2] text-[#800080] rounded-full text-xs font-bold uppercase">
                    {article.articleType}
                  </span>
                  <span className="text-sm text-gray-500">Pages {article.pages}</span>
                </div>
                <h3 className="text-2xl font-bold text-[#212121] mb-4 group-hover:text-[#800080] transition-colors font-serif leading-tight">
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white border-2 border-[#EAD3D9] rounded-xl p-6">
              <h3 className="text-xl font-bold text-[#800080] mb-4 flex items-center gap-2">
              ...
              <div className="block md:flex gap-2">
                <input
                  ...
                  className="flex-1 mb-2 w-full md:mb-0 px-4 py-2 border-2 border-[#EAD3D9] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#800080]"
                />
                <button className="bg-[#800080] text-white px-6 py-2 rounded-lg hover:bg-[#800080] transition-colors font-semibold">
                  Subscribe
                </button>
              </div>
            </div>
            <div className="bg-white border-2 border-[#EAD3D9] rounded-xl p-6">
              <h3 className="text-xl font-bold text-[#800080] mb-4">Citation Information</h3>
          ...
          <div className="mt-8 text-center">
            <Link
              href="/archives"
              className="inline-flex items-center gap-2 text-[#800080] hover:text-[#800080] font-semibold text-lg"
            >
